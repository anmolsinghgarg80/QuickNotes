...
// pin a note
  const updateIsPinned = async (noteData) => {
    ...
    try {
    const response = await axiosInstance.put("note/update-note-pinned/" + noteId,
    {
  ...
  return (
    <>
      ...
      <div className='container mx-auto px-10' >
        {allNotes.length > 0 ? <div className='flex flex-col md:grid grid-cols-3 gap-4 mt-8 '>
        ...
        </div> : (<EmptyCard message= {`Start creating your first note! Click the 'Add' button to write
      ...
      <Modal 
        ...
        contentLabel=""
        className="w-[70%] md:w-[50%] max-h-3/4 bg-white rounded-md mx-auto mt-14 p-5 overflown-scroll"
      >  
        <AddEditNotes 
